...
// ⚡ Bolt Optimization: Extracted CustomTooltip out of EngagementChart to prevent
// full unmount/remount on every parent render. Wrapped in React.memo for performance.
