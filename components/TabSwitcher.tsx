...
const TabSwitcher: React.FC<TabSwitcherProps> = ({ options, activeOption, onOptionClick }) => {
  ...
  return (
    <div ref={containerRef} role="tablist" className="relative flex p-1 bg-white/5 backdrop-blur-sm border border-[rgba(163,230,53,0.2)] rounded-lg select-none shadow-lg">
