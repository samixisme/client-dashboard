                    ...
                    <div className="flex justify-between items-center gap-4">
                        <div className="flex items-center gap-3 flex-1 min-w-0">
                            <input
                                ...
                                className="text-xl font-bold text-text-primary bg-transparent w-full focus:outline-none focus:bg-glass-light/60 rounded-xl px-2 py-1 -mx-2 -my-1 transition-all duration-300"
                            />
                        ...
                        <SidebarSection title="Assignees">
                             <div className="flex items-center gap-2 flex-wrap">
                                ...
                                <div className="relative">
                                    <button onClick={() => setIsAssigneeDropdownOpen(o => !o)} aria-expanded={isAssigneeDropdownOpen} aria-haspopup="true" className="h-8 w-8 rounded-full bg-surface-light border border-dashed border-border-color flex items-center justify-center text-text-secondary hover:border-primary hover:text-primary" aria-label="Add assignee" title="Add assignee"><AddIcon className="w-4 h-4" /></button>
                        ...
                        <SidebarSection title="Labels">
                             <div className="flex flex-wrap gap-1 items-center">
                                {taskCurrentTags.map(tag => (
                                 ...
                                 <div className="relative">
                                    <button onClick={() => setIsTagDropdownOpen(o => !o)} aria-expanded={isTagDropdownOpen} aria-haspopup="true" className="p-1 rounded-full bg-surface-light hover:bg-border-color" aria-label="Add tag" title="Add tag"><AddIcon className="w-3 h-3 text-text-secondary"/></button>
                                    {isTagDropdownOpen && (
                                        <div className="absolute top-full left-0 mt-2 w-56 p-2 bg-glass border border-border-color rounded-2xl shadow-2xl z-50 overflow-hidden">
                                            ...
                                            <div className="max-h-32 overflow-y-auto">
                                                ...
                                                {tagSearch && !boardTags.some(t => t.name.toLowerCase() === tagSearch.toLowerCase()) && (
                                                    <button onClick={() => handleCreateTag(tagSearch)} className="w-full text-left p-1 rounded hover:bg-white/10 text-xs text-primary transition-all">+ Create "{tagSearch}"</button>
                                                )}
                                            </div>
                                        </div>
                                    )}
