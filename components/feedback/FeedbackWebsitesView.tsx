                ...
                <ul className="divide-y divide-border-color/30">
                    {websites.map((website, index) => {
                        ...
                        return (
                            ...
                            >
                                <div>
                                    <p className="font-bold text-text-primary group-hover:text-primary transition-colors duration-300 text-lg">{website.name}</p>
                                    <p className="text-sm text-text-secondary/90 mt-1">{total} page(s)</p>
                                </div>
                                <div className="flex items-center gap-6">
                                    ...
                                    <Link
                                        to={`/feedback/${projectId}/websites/${website.id}`}
