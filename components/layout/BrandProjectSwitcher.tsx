    ...
    return (
        <div className="relative flex-shrink-0">
            <button
                ...
                aria-haspopup="true"
                aria-expanded={open}
                className={`h-11 w-11 flex items-center justify-center rounded-xl transition-all duration-200 cursor-pointer relative ${
                    open
                                                    ...
                                                    {brandProjects.length === 0 ? (
                                                        ...
                                                        brandProjects.map(project => {
                                                            ...
                                                            return (
                                                                ...
                                                                >
                                                                    <span className={`w-2 h-2 rounded-full flex-shrink-0 ${statusColors[project.status].split(' ')[0]}`} />
