...
// ⚡ Bolt: Extracting KanbanViewComponent to top-level to prevent full remounts on every parent render.
// This preserves DOM state and significantly improves drag-and-drop and input performance.
interface KanbanViewProps {
    ...
    setItemActionState: React.Dispatch<React.SetStateAction<{ anchorEl: HTMLElement | null, item: RoadmapItem | null }>>;
    setSelectedTask: React.Dispatch<React.SetStateAction<Task | null>>;
}

const KanbanViewComponent = memo(({
    projectTasks,
    roadmapItems,
    tasksByRoadmapItem,
    handleKanbanDragEnd,
