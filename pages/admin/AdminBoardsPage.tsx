...
// ⚡ Bolt Optimization: Extracted SortIcon outside of AdminBoardsPage to prevent
// React from completely unmounting and remounting this component on every parent render.
const SortIcon = ({ field, sortBy, sortDirection }: { field: SortField, sortBy: SortField, sortDirection: SortDirection }) => {
        ...
        <div className="bg-glass border border-border-color rounded-xl p-4 flex flex-col md:flex-row gap-4 items-center flex-wrap">
            ...
            <div className="flex items-center gap-2 ml-auto">
                ...
                <button onClick={() => handleSort('taskCount')} className="px-3 py-1.5 text-xs font-medium rounded-lg bg-glass-light hover:bg-border-color text-text-secondary flex items-center">
                    Tasks <SortIcon field="taskCount" sortBy={sortBy} sortDirection={sortDirection} />
                </button>
