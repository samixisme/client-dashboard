    ...
    <div className="space-y-6">
        <div className="flex flex-col md:flex-row justify-between items-start md:items-center gap-4">
         ...
         <div className="bg-glass border border-border-color rounded-xl p-10 flex flex-col items-center justify-center text-center">
             ...
             <h3 className="text-lg font-semibold text-text-primary">Task Management Module</h3>
             <p className="text-text-secondary max-w-md mt-2">
                 Centralized task management is in development. This view will provide a master list of all tasks across all projects.
             </p>
        </div>
    </div>
  );
